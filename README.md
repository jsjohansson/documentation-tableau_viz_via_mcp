...
`<PostedName>` is the **Tableau Public repository name, exactly as published** — the segment
after `/viz/` in the live URL:
...
drift. The posted name is the one identifier that is stable and resolvable — given a filename you
can reconstruct the live URL, and given a URL you can find the document.

That means the suffixes Tableau appends are kept verbatim:
...
[`comparison_skill_vs_no_skill_SuperstoreShippingMetrics.md`](comparison_skill_vs_no_skill_SuperstoreShippingMetrics.md):
...
| `HRAttritionDashboard_17728329067570` | HR Attrition Dashboard | 29 | 35 | 37 | 4 |
...
| `B2VB_001` | No Limits Scatter Plot | 24 | 30 | 19 | 12 |
...
| `NewYearsResolutionsMakeoverMonday_17054389050480` | New Year's Resolutions | 11 | 7 | 5 | 0 |
...
| `comparison_skill_vs_no_skill_SuperstoreShippingMetrics.md` | Controlled single-workbook comparison, inputs held constant |
